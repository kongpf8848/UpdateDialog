...
class MainActivity : AppCompatActivity() {
    ...
    private val iconList= listOf(R.mipmap.icon_pdj, R.mipmap.icon_jianshu,R.mipmap.icon_csdn,
        ...
        R.mipmap.icon_wealth,R.mipmap.icon_36kr
    )
    private val titleList= listOf(R.string.dialog_pdj, R.string.dialog_jianshu,R.string.dialog_csdn,R.string.dialog_dingdong,R.string.dialog_huobi,R.string.dialog_cloudmusic,R.string.dialog_wealth,R.string.dialog_36kr)
